...
function Band({
  ...
  const cardMap = useMemo(() => {
    ...
    const fTex = frontTex as any;
    const bTex = backTex as any;
  ...
  texAny.wrapS = texAny.wrapT = THREE.RepeatWrapping;
    ...
    <>
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          <CuboidCollider args={[1.24, 1.75, 0.015]} />
          <group
            scale={3.5}
            position={[0, -1.86, -0.077]}
